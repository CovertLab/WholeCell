...
classdef ConditionSet_Test < TestCase
    ...
    methods
        ...
        function testGenerateSingleGeneDeletionConditionSet(this)
            ...
            expectedConditionSet.fittedConstants = struct('states', struct(), 'processes', struct());
            expectedConditionSet.fixedConstants = struct('states', struct(), 'processes', struct());
        ...
        function value = getTestConditionSet(this)
            ...
            value = struct(...
                ...
                'fittedConstants', struct('states',struct,'processes',struct), ...
                'fixedConstants', struct('states',struct,'processes',struct), ...
