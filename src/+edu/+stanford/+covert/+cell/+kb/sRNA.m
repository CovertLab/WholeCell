% Defines a sRNA polymer
%
% Author: Jonathan Karr
% Affilitation: Covert Lab, Department of Bioengineering, Stanford University
% Last updated: 5/7/2009
classdef sRNA < edu.stanford.covert.cell.kb.ssRNA & edu.stanford.covert.cell.kb.Enzyme
    methods
        function this = sRNA(knowledgeBase, wid, wholeCellModelID, name, ...
                sequence, ...
            ...
            this = edu.stanford.covert.cell.kb.sRNA.empty(size(wid,1),0);
