% Defines a dsRNA polymer
%
% Author: Jonathan Karr
% Affilitation: Covert Lab, Department of Bioengineering, Stanford University
% Last updated: 5/7/2009
classdef dsRNA < edu.stanford.covert.cell.kb.NucleicAcid
    ...
    methods
        function this = dsRNA(knowledgeBase, wid, wholeCellModelID, name, ...
                sequence, ...
                comments, crossReferences)
            
            if nargin == 0; return; end;
            
            this = edu.stanford.covert.cell.kb.dsRNA.empty(size(wid,1),0);
            this(size(wid,1),1) = edu.stanford.covert.cell.kb.dsRNA;
            for i = 1:size(wid,1)
                this(i,1).idx = i;
        ...
        function value = get.empiricalFormula(~)
            throw(MException('dsRNA:error', 'property is not defined'));
        end
        ...
        function value = get.baseCount(this)
            ...
            %calculate
            value = this.computeBaseCount(this.sequence, this.knowledgeBase.numMetabolites, this.knowledgeBase.nmpIndexs);
        ...
        function value = get.cumulativeBaseCount(this)
            ...
            value(:,this.knowledgeBase.nmpIndexs) = 2*[...
                sequence == 'A' ...
                sequence == 'C' ...
                sequence == 'G' ...
                sequence == 'U'];
        ...
        function value = get.extinctionCoefficient(this)
            ...
            for i = 1:length(sequence)-1
                idx1 = idx2;
                idx2 = n2int(sequence(2), 'Alphabet', 'RDNA');
    ...
    methods (Static = true)
        ...
        function value = calculateMolecularWeight(sequence, sequenceLength, sequenceTopology, nmpMolecularWeights)
            ...
            value = 2 * (nmpCount * nmpMolecularWeights - ...
