...
classdef Process < edu.stanford.covert.cell.kb.KnowledgeBaseObject
    properties
    ...
    methods
        function this = Process(knowledgeBase, wid, wholeCellModelID, name, ...
                initializationOrder, evaluationOrder, class, ...
                comments, crossReferences)

            if nargin == 0; return; end;

            this = edu.stanford.covert.cell.kb.Process.empty(size(wid, 1), 0);
            this(size(wid, 1), 1) = edu.stanford.covert.cell.kb.Process;
            for i = 1:size(wid, 1)
                this(i, 1).idx = i;
                ...
                this(i, 1).initializationOrder = initializationOrder(i);
                this(i, 1).evaluationOrder = evaluationOrder(i);
