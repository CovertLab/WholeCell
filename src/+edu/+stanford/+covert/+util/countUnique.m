function [uniques,numUnique] = countUnique(x,option)
...
% Contact: anthony [dot] kendall [at] gmail [dot] com, http://www.mathworks.com/matlabcentral/fileexchange/23333
% Created: 2009-03-17
...
if maxVal / numel(x) > 1000
    throw(MException('countUnique','Accumarray is inefficient for arrays when ind values are >> than the number of elements'))
end
